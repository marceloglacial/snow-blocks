...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__["registerBlockType"])('snow-blocks/forms', {
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Forms', 'forms'),
  category: 'widgets',
  icon: 'feedback',
  supports: {
    html: false
  ...
  edit: function edit(props) {
    var formType = props.attributes.formType;
    var forms = {
      formspree: {
        title: 'Formspree',
    ...
    var formsData = _objectSpread(_objectSpread({}, props), {}, {
      forms: forms
    });

    if (!formType) return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_components_FormsSelection__WEBPACK_IMPORTED_MODULE_4__["default"], formsData);
    return forms[formType].component;
  },
  save: function save(props) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("p", null, "test");
  }
});
...
/* harmony import */ var _functions_addField__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../functions/addField */ "./src/Blocks/Forms/functions/addField.js");
/* harmony import */ var _InputView__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./InputView */ "./src/Blocks/Forms/components/InputView.js");
...
var FormsPree = function FormsPree(props) {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(formUrl),
      _useState2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2___default()(_useState, 2),
      url = _useState2[0],
      setUrl = _useState2[1];

  var handleUrl = function handleUrl(e) {
    return setUrl(e);
  };

  var handleSetUrl = function handleSetUrl(e) {
    return setAttributes({
      formUrl: url
    });
  };

  if (!formUrl) return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", {
    className: "form-container"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("label", {
    htmlFor: "url"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("h3", null, "Form endpoint")), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("input", {
    name: "url",
    id: "url",
    type: "url",
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("div", {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])("button", {
      ...
      onClick: function onClick(e) {
        return Object(_functions_addField__WEBPACK_IMPORTED_MODULE_5__["default"])(_objectSpread(_objectSpread({}, type), {}, {
          fields: formFields,
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_3__["createElement"])(_InputView__WEBPACK_IMPORTED_MODULE_6__["default"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
      key: field.id
    }, field));
  })));
};
...
var FormsSelection = function FormsSelection(props) {
  var setAttributes = props.setAttributes,
      forms = props.forms;
  var allTypes = Object.entries(forms);
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    className: "forms-selection snowforms"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("h3", {
    className: "forms-selection__title"
  }, "Choose Your Form:"), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("form", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("select", {
    onChange: function onChange(e) {
      return handleSelection(e.target.value);
    }
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("option", {
    value: ""
  }, "---- choose one ----"), allTypes.map(function (item, index) {
