...
function create_block_snow_blocks_block_init() {
	...
	if ( ! file_exists( $script_asset_path ) ) {
		throw new Error(
			'You need to run `npm start` or `npm run build` for the "create-block/snow-blocks" block first.'
		);
	}
	$index_js     = 'build/index.js';
	$script_asset = require( $script_asset_path );
	wp_register_script(
		'create-block-snow-blocks-block-editor',
		plugins_url( $index_js, __FILE__ ),
		$script_asset['dependencies'],
		$script_asset['version']
	);
	wp_set_script_translations( 'create-block-snow-blocks-block-editor', 'snow-blocks' );
	...
	wp_register_style(
		'create-block-snow-blocks-block',
		plugins_url( $style_css, __FILE__ ),
		array(),
		filemtime( "$dir/$style_css" )
	);

	register_block_type( 'create-block/snow-blocks', array(
		'editor_script' => 'create-block-snow-blocks-block-editor',
		'editor_style'  => 'create-block-snow-blocks-block-editor',
		'style'         => 'create-block-snow-blocks-block',
	) );
}
